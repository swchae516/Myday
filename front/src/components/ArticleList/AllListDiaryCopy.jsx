...
function AllListDiaryCopy() {
  ...
  return (
    <div>
      <StyledCenter className="v-center">
        <StyledContainer className="container">
          <StyledBook className="book">
            ...
            <div className="second paper">
              <div className="page front contents">
                <div className="vara-container"></div>
              </div>
              <div className="page back"></div>
            </div>
            ...
            <StyledSide className="side"></StyledSide>
            <StyledBottom className="bottom"></StyledBottom>
            <StyledShadow className="shadow"></StyledShadow>
          </StyledBook>
        </StyledContainer>
      </StyledCenter>
    </div>
...
export default AllListDiaryCopy
